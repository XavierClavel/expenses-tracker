...
import com.xavierclavel.bankable.resources.screen_select_tags
...
fun TagPickerScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(Res.string.screen_select_tags)) },
                navigationIcon = {
        ...
        if (tags.isEmpty()) {
            Box(
                ...
                Text(stringResource(Res.string.tags_empty), color = MaterialTheme.colorScheme.onSurfaceVariant)
            }
        } else {
            LazyColumn(
                modifier = Modifier
