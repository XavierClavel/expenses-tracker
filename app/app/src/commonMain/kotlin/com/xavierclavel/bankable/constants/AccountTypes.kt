...
import com.xavierclavel.bankable.resources.account_type_checking
import com.xavierclavel.bankable.resources.account_type_investment
import com.xavierclavel.bankable.resources.account_type_other
import com.xavierclavel.bankable.resources.account_type_retirement
import com.xavierclavel.bankable.resources.account_type_savings
...
enum class AccountType(
    ...
    CHECKING("CHECKING", Res.string.account_type_checking, Icons.Default.AccountBalanceWallet, 210f),
    SAVINGS("SAVINGS", Res.string.account_type_savings, Icons.Default.Savings, 135f),
    INVESTMENT("INVESTMENT", Res.string.account_type_investment, Icons.AutoMirrored.Filled.TrendingUp, 280f),
    RETIREMENT("RETIREMENT", Res.string.account_type_retirement, Icons.Default.Elderly, 35f),
    OTHER("OTHER", Res.string.account_type_other, Icons.Default.MoreHoriz, -1f);
    ...
    val accentColor: Color get() = hsvToColor(
