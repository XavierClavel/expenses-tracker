...
import {createAccountReport, deleteAccountReport, updateAccountReport} from "@/src/api/account-reports";
        ...
        <SafeAreaView
            ...
            />
              ...
              <Pressable
                  ...
                  onPress={async () => {
                      const accountReport = new AccountReportIn(
                          amount,
                          date.toLocaleDateString('sv-SE'),
                      )
                      try {
                          if (selectedAccountReport) {
                              await updateAccountReport(selectedAccountReport.id, accountReport)
                          } else {
