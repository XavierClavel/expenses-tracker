...
import com.xavierclavel.bankable.resources.cd_add_category
        ...
        floatingActionButton = {
            Row(
                ...
                SmallFloatingActionButton(onClick = { navController.navigate("tags") }) {
                    Icon(Icons.AutoMirrored.Filled.Label, contentDescription = stringResource(Res.string.nav_tags))
                }
                FloatingActionButton(onClick = {
                    viewModel.prepareNewCategory()
                    navController.navigate("category/edit")
                }) {
                    Icon(Icons.Default.Add, contentDescription = stringResource(Res.string.cd_add_category))
                }
            }
        }
    ) { padding ->
